...
MP rules: lower MP flees while looking for power, higher MP chases enemy,
equal MP searches future moves with minimax.
"""
...
from ai.minimax import minimax_decide_move, next_step_toward_goal, shortest_path_len
